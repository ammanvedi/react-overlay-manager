...
6. Events for handling overlays overflowing the viewport

<Canvas>
    <Story height={'385px'} id="overlay-manager--simple-notifications" />
</Canvas>
...
in every permutation of interaction with other overlays across the site.

With this library you should be able to define rules and rest easy knowing that layout will be
handled properly.
...
There is a stress test available to view, you can see that the overlay manager performs
